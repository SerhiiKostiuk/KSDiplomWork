//
//  KSPersonalFinance-Bridging-Header.h
//  KSPersonalFinance
//
//  Created by Сергій Костюк on 28.06.16.
...
SWIFT_CLASS("_TtC10ChartsDemo13BalloonMarker")
...
- (nonnull instancetype)initWithColor:(UIColor * _Nonnull)color font:(UIFont * _Nonnull)font insets:(UIEdgeInsets)insets OBJC_DESIGNATED_INITIALIZER;
