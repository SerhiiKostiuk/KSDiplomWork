...
@implementation KSYearPickerView
...
- (NSDate *)date {
    ...
    NSString *year = [self.years objectAtIndex:([self selectedRowInComponent:1] % yearCount)];
...
//Create Years Array from 2000 to 2030 year
...
//            row = row + (self.years.count *1000) / 2;
            break;
        }
    }
